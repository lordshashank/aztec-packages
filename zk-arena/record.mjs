...
//
// Usage: node zk-arena/record.mjs --verdict=<verdict.json> --pr=<n> --title=<t> --author=<login> --merge=<sha>
...
appendFileSync(logPath, JSON.stringify({ ts: new Date().toISOString(), pr: args.pr, author: args.author, mergeSha, verdict }) + '\n');
