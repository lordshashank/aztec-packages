...
// ===== Begin backport from origin/next: Booth/Straus MSM helpers + indexed batch-affine ops =====
namespace detail {
 ...
 *
 * @details Variant of `batch_affine_add_interleaved` that gathers operands by index from a shared bucket
 *          array. Used by the bucket-reduction path in `scalar_multiplication_fast.cpp`, where the
 ...
 *
 * @details Variant that gathers operands by index. One Fq inversion
